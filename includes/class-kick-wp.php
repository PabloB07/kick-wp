...
class Kick_Wp {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Kick_Wp_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Kick_Wp_Loader. Orchestrates the hooks of the plugin.
	 * - Kick_Wp_i18n. Defines internationalization functionality.
	 * - Kick_Wp_Admin. Defines all hooks for the admin area.
	 * - Kick_Wp_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		...
		/**
		 * The class responsible for handling Kick.com API interactions
		 */
	 ...
	 *
	 * Uses the Kick_Wp_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Kick_Wp_Loader    Orchestrates the hooks of the plugin.
	 */
